    ...
    <section id="ourPrograms" className='ourPrograms'>
                ...
                <div className="row program">
                    ...
                    <div className="col-12 col-md-6 container">
                        <div>
                            <h3>Family</h3>
                            <p className="text-main">This multidisciplinary program seeks not only the mental and emotional well-being of the community but also its physical health. Giving them access to preventative health programs, medical campaigns, and so on. Together with the psychological accompaniment, it offers workshops for each member of the families, seeking to promote integral health and their development as independent people.</p>
                            <a href="">Learn more..</a>
                        </div>
                    </div>
                </div>
